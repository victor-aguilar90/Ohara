    ...
    return (
        <View style = {Styles.container}>
            <View style = {Styles.form}>
                ...
                <TextInput style = {Styles.inp} placeholder="Digite o título" value={titulo} onChange={setTitulo}/>
                <Text style = {Styles.label}>Autor:</Text>
                <TextInput style = {Styles.inp} placeholder="Digite o nome do autor" value={autor} onChange={setAutor}/>
                <Text style = {Styles.label}>Descrição:</Text>
                <TextInput style = {Styles.inp} placeholder="Digite uma pequena descrição" value={descricao} onChange={setDescricao}/>
                <Text style = {Styles.label}>Quantidade Dísponivel:</Text>
                <TextInput style = {Styles.inp} placeholder="Digite a quantidade"/>
                <Text style={Styles.label}>URL da Imagem</Text>
                <TextInput style={Styles.inp} value={imagem} onChangeText={setImagem}/>
